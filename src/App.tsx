...
export default function App() {
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-0 sm:p-4 overflow-hidden relative">
      ...
      {/* Rotation Prompt for Mobile Portrait ONLY */}
      <div className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-6 text-center sm:hidden portrait:flex landscape:hidden pointer-events-none">
        ...
        <p className="text-zinc-400 text-sm uppercase tracking-widest">Landscape mode required for mobile play</p>
      </div>
