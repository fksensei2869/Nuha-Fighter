...
export default function App() {
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-0 sm:p-4 overflow-hidden relative">
      ...
      {/* Rotation Prompt for Mobile Phones in Portrait ONLY (Hidden on tablets/desktop) */}
      <div className="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-6 text-center portrait:flex md:hidden landscape:hidden pointer-events-auto">
        ...
        <p className="text-zinc-400 text-sm uppercase tracking-widest text-balance">Landscape mode required for mobile play</p>
      </div>
      
      <footer className="mt-8 text-zinc-600 text-[10px] uppercase tracking-[0.2em] landscape:hidden sm:landscape:block">
